 ...
 */
/*
 * OBJC_API_VERSION 0或undef：仅限Tiger和较早版本的API
 * OBJC_API_VERSION 2：豹和更新的API可用
 */
...
/*
  * OBJC_NO_GC 1：不支持GC
  * OBJC_NO_GC undef：支持GC。 此SDK不再支持此模式。
  *
  * OBJC_NO_GC_API undef：库必须导出任何符号
  *双模式代码可能链接到。
  * OBJC_NO_GC_API 1：库不需要导出与GC相关的符号。
  */
